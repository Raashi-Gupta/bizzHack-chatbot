...
export const businessList = [
   {id:"B1", name: 'EHS Safety Regulations', value: 'EHS', color: '#00CFE8', icon: 'pi-car',redirect:"/chat" },
   {id:"B2", name: 'Tata Motors', value: 'TATA', color: '#FF9F43', icon: 'pi-building',redirect:"/chat" },
